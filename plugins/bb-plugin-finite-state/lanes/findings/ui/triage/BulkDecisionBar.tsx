...
export function BulkDecisionBar({ count, predicate, sharedCollisionRows, existingDecisionCount, open, confirming, pending, status, failures, outcome, onOpen, onStatus, onConfirm, onRetry, onCancel }: {
  count: number;
  predicate: boolean;
